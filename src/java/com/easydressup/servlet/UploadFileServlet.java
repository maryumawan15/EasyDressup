    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (null != category) {
                ...
                if (null != user) {
                    DatabaseUtil.uploadCloths(category.getCategoryId(), inputStream, user.getUserId(), contentType, fileName);
                    request.getSession().setAttribute("message", "Cloths uploaded successfully");
                    request.getSession().setAttribute("messageClass", "alert-success");
                    response.sendRedirect("category?parent=" + category.getParent().getCategoryName() + "&subcat=" + categoryId);
                }
            } else {
